...
class VentanaPrincipal(QMainWindow):
    def __init__(self):
        ...
        barra_herramientas.addAction(accion_Deshacer)
        barra_herramientas.addAction(accion_Rehacer)
        barra_herramientas.addAction(accion_pegar)
        barra_herramientas.addAction(accion_copiar)
        barra_herramientas.addAction(accion_cortar)
        barra_herramientas.addAction(accion_buscar)
        barra_herramientas.addAction(accion_reemplazar)
        barra_herramientas.addAction(accion_insertar_imagen)
